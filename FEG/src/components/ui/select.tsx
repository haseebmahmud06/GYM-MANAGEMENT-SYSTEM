 ...
 * Provides an accessible dropdown used in forms (e.g. picking a package's
 * Category and Package Type) with consistent theme styling.
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-lg border border-charcoal-300 bg-transparent px-3 py-2 text-sm',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        'relative z-[60] min-w-[8rem] overflow-hidden rounded-lg border border-charcoal-200 bg-white shadow-lg',
        'dark:border-charcoal-800 dark:bg-charcoal-900',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-charcoal-100 dark:focus:bg-charcoal-800',
